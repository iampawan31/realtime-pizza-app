...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      time.innerHTML = moment__WEBPACK_IMPORTED_MODULE_2___default()(order.updatedAt).format('hh:mm A');
...
var adminPathArea = window.location.pathname;
...
__webpack_require__(/*! /Users/pawankumar/Code/realtime-pizza-app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/pawankumar/Code/realtime-pizza-app/resources/scss/app.scss */"./resources/scss/app.scss");
